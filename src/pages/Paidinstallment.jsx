...
const Paidinstallment = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (column) => (
                <span className="px-5 py-1 text-base font-medium rounded-full border border-[#17A24A] text-[#17A24A] bg-[#FFFFFF]">
                    {column.status}
                </span>
            )
        },
            ...
            <div>
                ...
                <div className='bg-[#FFFFFF] w-full rounded-xl shadow-[0px_12.67px_22.52px_0px_rgba(208,210,218,0.15)] h-auto border-1 border-[#E1E7EF] '>
                    <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-8 gap-2 sm:gap-0'>
                        ...
                        <div>
                            <h1 className='text-[#17A24A] text-3xl sm:text-6xl font-medium'>65 / 665,580</h1>
                        </div>
                    </div>
                </div>
                ...
                {/* data-table */}
                <div className='mt-4'>
                    <DataTable rows={dummyrows} columns={columns} />
                </div>
            </div>
