            ...
            <div className="min-h-screen">
                <div className="max-w-6xl mx-auto space-y-6">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200/60 flex flex-col sm:flex-row items-center gap-6">
                        ...
                        <div className="flex-1 text-center sm:text-left space-y-3 w-full">
                            <div>
                                ...
                                <p className="text-sm text-blue-600 font-medium">{employee.job_title || "No Title Assigned"}</p>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200/60 flex flex-col justify-between">
                            <div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    {renderRow("Job Title", employee.job_title)}
                        ...
                        {/* Banner/Graphic Profile Section */}
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200/60 flex flex-col justify-between">
                            <div>
                                <div className="flex items-center gap-3 pb-4 mb-4 border-b border-gray-100">
                                    ...
                                    <h2 className="text-lg font-bold text-gray-800">Banner Profile</h2>
                                </div>
                                <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50 flex items-center justify-center min-h-[140px]">
                                    {employee.banner_url ? (
                                        <img
                                            src={employee.banner_url}
                                            alt="User Banner Profile"
                                            className="w-full h-full object-cover"
                                        />
                                    ) : (
                                        <span className="text-xs text-gray-400 italic text-center px-2">
                                            Banner Graphic Missing
                                        </span>
                                    )}
                                </div>
                            </div>
